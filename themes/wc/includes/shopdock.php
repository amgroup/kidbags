	...
	<div id="shopdock-inner">
		...
		<div id="cart-wrap">
			...
			<?php } ?>
				...
				<button type="submit" class="button checkout" onClick="document.location.href='<?php echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>'; return false;"><?php _e('Buy it', 'woocommerce')?></button>
			</p>
			<!-- /checkout-botton -->
