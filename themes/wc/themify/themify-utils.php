...
add_action( 'template_redirect', 'themify_feature_size_page' );
	...
	///////////////////////////////////////
	$locale = apply_filters( 'plugin_locale', get_locale(), 'themify' );

	load_textdomain( 'woocommerce', THEME_DIR."/languages/woocommerce-$locale.mo" );
	load_textdomain( 'themify', THEME_DIR."/languages/themify-$locale.mo" );
